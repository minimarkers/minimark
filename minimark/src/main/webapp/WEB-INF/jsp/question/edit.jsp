...
<form:form commandName="question" method="POST" action="${cp}/question/save.html">
    ...
    <div class="formButtons">
        <input type="submit" value="<spring:message code='Save' text='?Save?'/>" class="submit-button"/>&nbsp;&nbsp;<a href="list.html?courseId=${question.course.id}" class="action-back"><spring:message code="Back" text="?Back?"/></a>
    </div>
</form:form>
