...
<form:form commandName="question" method="POST" action="${cp}/question/save.html">
    ...
    <div class="formButtons">
        <a href="list.html?course.id=${question.course.id}" class="action action-back"><spring:message code="Back" text="?Back?"/></a>&nbsp;&nbsp;<input type="submit" value="<spring:message code='Save' text='?Save?'/>" class="submit-button"/>
    </div>
</form:form>
